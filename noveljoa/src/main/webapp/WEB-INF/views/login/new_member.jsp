...
#terms2{width: 1000px;height: 700px;display: flex;justify-content: center;align-items: center;position: absolute; top: 600px;}
...
<script type="text/javascript">
 $(function(){
	 <%-- <%= request.getParameter("agree1") %>사용하면 on이나 null이 나옴 --%>

	
	$("#agreeBtn").click(function(){
		if( !($("#chkBox1").prop("checked")) ||  !($("#chkBox2").prop("checked")) ){
			alert("항목에 모두 체크해주세요.");
			return;
		}
		window.location.href="new_member2.jsp"
 	});
}); 
...
<body>
           ...
           <%
            ...
            /* on이 비교가 안됨 */
          if("on".equals(agree1)&&"on".equals(agree2)){
        	  %>
        	 <script>
        	 window.close();
    ...
    <div id="wrap">
       ...
       <div id="container">
           <div id="terms1">
            ...
            <div id="img"></div>
            <div id="text_service">서비스이용약관</div>
        ...
        <textarea readonly="readonly">
            ...
            <div id="checkBox1">
                <input type="checkbox" id="chkBox1" name="agree1" style="width: 15px;height: 15px;border: 1px solid #333">동의
       ...
       <div id="terms2">
           ...
           <div id="privacy">개인정보 수집 및 활용 동의</div>
         <div id="term2">
<textarea readonly="readonly">
    제 1장 총칙
    제 1 조 (목적)
    ...
    <div id="checkBox2">
		<input type="checkbox" id="chkBox2" name="agree2" style="width: 15px;height: 15px;border: 1px solid #333" >동의
