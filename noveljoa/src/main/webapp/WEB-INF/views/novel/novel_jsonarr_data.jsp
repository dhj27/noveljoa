<%@page import="novel.ListEpisodeVO2"%>
<%@page import="novel.EpisodeDAO2"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	EpisodeDAO2 epDAO = new EpisodeDAO2();
    
    try{
    	// 에피소드 회차 출력
		List<ListEpisodeVO2> list = epDAO.selectAllEp(novelNum);
