...
<div class="lightMode h-full">
				...
				<main class="flex-1">
					...
					<div
						...
						<div
							...
							<div style="height: 0px" class="flex flex-col col-span-full" >
								<div>
								...
								<article
									...
									<div class="flex flex-1 flex-col desktop:flex-row">
										<div
											...
											<div
												...
												<span class="typo-g-sm2 -mb-[0.2em]">작성일</span><span
													class="mx-4 text-10 !mx-6 mb-1 block text-black/10 desktop:!mx-8">|</span>
												<span class="typo-g-sm2 -mb-[0.2em]">조회수</span>
											</div>
										</div>
								</article>
									...
									<div
										class="flex typo-g-md2 mt-2 mr-12 desktop:mr-16 desktop:typo-g-lg2"></div>
										<div
											class="flex flex-1 flex-col justify-start overflow-hidden desktop:mr-80" style="height: 400px">
											풀어주셈
										</div>
								</article>
							</div>
 		...
 		<div style="height: 30px">
 			<button class="flex items-center cursor-pointer typo-md3-b text-subText" type="button">매니저</button>
 		</div>
 		
 		<form class="flex flex-col w-full">
	 		<textarea  placeholder="답변을 입력하세요." name="body" maxlength="500" class="typo-md3 rounded-3 border-1 border-grey30 py-14 px-16 placeholder:text-grey60 flex-[1_1_100%] resize-none outline-none typo-md3 min-h-[66px] border-none !bg-transparent !p-0 text-commentText"></textarea>
	 		<div class="flex mt-8 w-full items-center justify-between">
		 		...
		 		<button class="flex items-center justify-center border-1 appearance-none bg-black border-black text-white disabled:border-grey20 disabled:bg-grey20 disabled:text-grey60 typo-sm1-b py-1 px-16 desktop:!font-medium ml-8 rounded-full" type="submit">등록</button>
		 		</div>
	 		</div>
 		</form>
 		</div>
 		...
 		<div class="flex typo-md2 items-center justify-center text-grey60 min-h-[400px] flex-1">
