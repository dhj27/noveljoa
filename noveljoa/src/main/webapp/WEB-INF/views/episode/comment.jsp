...
<%-- <input type="hidden" name="novelNum" value="<%= novelNum %>"> --%>
	...
	<main class="flex-1">
		...
		<div>
 		...
 		<div class="border-commentFormLine border-t-1 bg-commentTextForm p-16 desktop:rounded-3  desktop:border-1 bg-commentTextForm">
 		<div class="mt-4 mb-8">
 			<button class="flex items-center cursor-pointer typo-md3-b text-subText" type="button">아이디</button>
 		</div>
 		
 		<form class="flex flex-col w-full">
	 		<textarea  placeholder="댓글을 입력하세요." name="body" maxlength="500" class="typo-md3 rounded-3 border-1 border-grey30 py-14 px-16 placeholder:text-grey60 flex-[1_1_100%] resize-none outline-none typo-md3 min-h-[66px] border-none !bg-transparent !p-0 text-commentText"></textarea>
	 		<div class="flex mt-8 w-full items-center justify-between">
		 		<label class="flex typo-md3 items-start"></label>
		 		<div class="flex items-center">
		 		<span class="typo-x-sm">
 		...
 		<div class="flex items-center">
 		<h2 class="typo-lg3-b mr-6 desktop:typo-lg1">댓글</h2>
 		<span class="typo-g-sm2 -mb-[0.2em] !desktop:typo-g-lg1 !typo-g-lg3 desktop:text-grey60">(0)</span>
 		</div>
 		</div>
 		</div>
 		</div>
