	 ...
	 $.ajax({
		...
		success : function(jsonArr){
			...
			$.each(jsonArr,function(idx, jsonObj){
				...
				article1 += '<div class=\"flex flex-wrap mb-8 items-center\"><div class=\"flex mb-2 items-center desktop:mb-0\">'
			...
			if(cnt == 0){
				article1 += "<div class='flex flex-col mb-120 shrink-0 items-center text-center'>"
